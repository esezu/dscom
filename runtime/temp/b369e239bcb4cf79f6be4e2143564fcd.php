<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/usr/local/lighthouse/softwares/btpanel/wwwroot/dscom/apps/p/view/pay/qiqizhifu.html";i:1618344121;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="body" id="body">
    ...
    <div class="mod-ct">
        ...
        <div id="orderbody">
            ...
            <div class="amount" id="money">￥<span id="copy_money"><?php echo $paydata['price']; ?></span></div>
            <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
                <div data-role="qrPayImg" class="qrcode-img-area">
                    <div class="ui-loading qrcode-loading" data-role="qrPayImgLoading" style="display: none;">加载中</div>
                    <div style="position: relative;display: inline-block;">
                        <img id='show_qrcode' alt="加载中..." src="/cn/qr?url=<?php echo $paydata['payCode']; ?>" width="250" height="250" style="display: block;">
                    </div>
                </div>
            </div>
            ...
            <div class="detail" id="orderDetail">
                <dl class="detail-ct" id="desc" style="display: none;">
                    <dt>订单金额：</dt>
                    <dd><?php echo $paydata['price']; ?></dd>
                    <dt>商户订单号：</dt>
                    <dd><?php echo $paydata['order_id']; ?></dd>
                    <dt>创建时间：</dt>
        ...
        <div class="tip-text"><a id="alink" href="<?php echo $paydata['return_url']; ?>" style="visibility: hidden;display:none;">下一步</a> </div>
...
<script>
    ...
    function check() {
        $.ajax({
            type: "POST",
            url: '/p/pay/getorder',
            data:{'id':"<?php echo $paydata['order_id']; ?>"},
            success: function (data) {
                if (data == 2){
                    window.location.href = "<?php echo $paydata['return_url']; ?>";
                    return;
                } else{
