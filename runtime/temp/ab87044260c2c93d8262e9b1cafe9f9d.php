<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"/www/wwwroot/dscom/apps/admins/view/user/adduser.html";i:1639358997;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" action="" style="margin-top: 20px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="money" value="<?php echo $uinfo['money']; ?>"  autocomplete="off" placeholder="账户余额" class="layui-input">
        </div>
    </div>
