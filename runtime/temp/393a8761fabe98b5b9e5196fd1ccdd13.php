<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/usr/local/lighthouse/softwares/btpanel/wwwroot/dscom/apps/admins/view/ename/ground.html";i:1618538186;}*/ ?>
  ...
  <div class="layui-row">
    <div class="layui-col-xs12">
       <div class="layui-form" id="table-list">
          ...
          <table class="layui-table" lay-data="{height: 'full-130',  page: true, limit:16,id:'ajaxData', url:'<?php echo url('ename/ground'); ?>'}" lay-filter="ajaxData">
            <thead>
              <tr>
...
window.st = function(id,st){
 ...
 window.del = function(id){
       $.ajax({
        url:'<?php echo url("ename/dels"); ?>?id='+id,
        dateType:'json',
        success:function(e){
          layer.msg(e.msg);
          if(e.code =200){
...
window.dels = function(){
   $.ajax({
        url:'<?php echo url("ename/deldile"); ?>',
        success:function(e){
          layer.msg(e.msg);
          if(e.code =200){
            setTimeout(function(){
