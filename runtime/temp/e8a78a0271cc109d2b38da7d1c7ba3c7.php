<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"/www/wwwroot/dscom/apps/p/view/home/list5.html";i:1634339758;}*/ ?>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.video_items', function(e) {
            ...
            var html = '<div class="image">' +
                ...
                '<div class="item pay" onclick="javascript:layer.load(3,{shade:0.6,content :\'正在支付\'});window.location.href =\''+pl+'\';">打赏' + price + '元观看</div>' +
                '</div>'
