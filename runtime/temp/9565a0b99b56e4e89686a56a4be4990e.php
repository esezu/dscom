<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"/www/wwwroot/dscom/apps/cn/view/home/login.html";i:1635385028;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="" id = 'databox'  method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="account"  lay-verify="required|account" placeholder="用户名" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                 ...
                 <?php  if($is_reg == 2){  ?>
                <div class="layui-form-item">
                   <a href="<?php echo url('register'); ?>"  style="float: right;">立即注册</a>
                </div>
                <?php  }  ?>
            </form>
        </div>
