<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/usr/local/lighthouse/softwares/btpanel/wwwroot/dscom/apps/p/view/home/play.html";i:1618545882;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="prism-player videobox" id="video"></div>
  <div class="nav-height" id="navHeight">
    <h4 class="head-title">文件较大  稍作缓冲  即可播放</h4>
  </div>
  <ul class="fix">
