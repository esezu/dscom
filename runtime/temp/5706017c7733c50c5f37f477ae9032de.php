<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/usr/local/lighthouse/softwares/btpanel/wwwroot/dscom/apps/cn/view/promoters/video.html";i:1618530069;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-form" id="table-list">
                ...
                <div style="background-color: #eee;padding: 15px;">
                    <div class="layui-inline">
                        <button type="button"  class="layui-btn layui-btn-normal " onclick="getlink()">推广链接</button>
                        <button type="button"  class="layui-btn layui-btn-success " onclick="getboxlink()">盒子</button>
                    </div>
                    <div class="layui-input-inline">
                        <input type="radio" name="types" value="1" title="短链" checked="">
                        <!--<input type="radio" name="types" value="2" title="原链">-->
                    </div>
                    <div class="layui-input-inline">
