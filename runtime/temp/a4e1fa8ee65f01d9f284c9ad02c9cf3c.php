<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"/www/wwwroot/esezu/apps/p/view/pay/qiqizhifu.html";i:1622612955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="body" id="body">
    ...
    <div class="mod-ct">
        ...
        <div id="orderbody">
            ...
            <div class="amount" id="money">￥<span id="copy_money"><?php echo $paydata['totalAmount']; ?></span></div>
