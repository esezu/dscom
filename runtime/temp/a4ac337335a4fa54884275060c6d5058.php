<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/usr/local/lighthouse/softwares/btpanel/wwwroot/dscom/apps/admins/view/user/order.html";i:1597109366;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <div class="layui-row">
    <div class="layui-col-xs12">
       <div class="layui-form" id="table-list">
          ...
          <table class="layui-table" lay-data="{height: 'full-115',  page: true, limit:17,id:'ajaxData', url:'<?php echo url('order'); ?>'}" lay-filter="ajaxData">
            <thead>
              <tr>
